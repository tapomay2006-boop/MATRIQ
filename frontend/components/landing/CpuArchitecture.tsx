    ...
    return (
        ...
        >
            ...
            <g>
                ...
                {/* CPU Image or Text */}
                {imageUrl ? (
                    <foreignObject x="87" y="42" width="26" height="16">
                    ...
                    <foreignObject x="86" y="41" width="28" height="18">
                        <div className="w-full h-full bg-transparent flex items-center justify-center text-[5px] font-semibold text-white">
                            {/* Transparent div wrapper for future images/components */}
                        </div>
                    </foreignObject>
                )}
            </g>
